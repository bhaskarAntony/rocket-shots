  ...
  <section className="container-fluid p-3 p-md-5">
    <div className="row align-items-center bg-dark p-3 p-md-5 rounded-2">
        <div className="col-md-4">
            <img src="https://img.freepik.com/free-vector/retinal-biometric-scan-cyber-security-technology-blue-tone_53876-119535.jpg?ga=GA1.1.1471963966.1728382128&semt=ais_hybrid" alt="" className="w-100 rounded-4" />
        </div>
