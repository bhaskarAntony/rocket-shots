...
function Works() {
  return (
    <section className="container-fluid p-3 p-md-5 dark2 text-white works">
        ...
        <video src={insta2} className="w-100 v1" autoPlay loop muted controls 
        ...
        <div class="col-lg-4 mb-4 mb-lg-0">
        <video src={insta4} className="w-100 v2" autoPlay loop muted controls data-aos="zoom-in"></video>
